...
for_state : FOR '(' expr ';' expr ';' expr ')' statement { $$ = Node::make_list(5, IDNode::Create("for"), $3, $5, $7, $9); }
          ...
          | FOR '(' ID IN expr ')' statement { $$ = Node::make_list(4, IDNode::Create("foreach"), $3, 0, $5); }
          | FOR '(' var_def IN expr ')' statement { $$ = Node::make_list(4, IDNode::Create("foreach"), Node::Create($3), 0, $5); }
          | FOR '(' ID OF expr ')' statement { $$ = Node::make_list(4, IDNode::Create("foreach"), 0, $3, $5); }
